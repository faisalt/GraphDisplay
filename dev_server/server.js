...
function LockedData() {
	var lockedRows=[], lockedColumns=[], lockedRowIndices=[], lockedColIndices=[], actualColIndices=[], actualRowIndices=[], lastDataWindow=[];
	...
	this.setLastLockedDataWindow=function(dw) {
		lastDataWindow = JSON.parse(JSON.stringify(dw.slice(0)));
	}
	this.getLastLockedDataWindow=function() {
